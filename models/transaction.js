...
module.exports = (sequelize, DataTypes) => {
  ...
  Transaction.init({
    ...
    type: { type: DataTypes.ENUM('partner_withdrawal', 'entry_purchase', 'prize_win', 'refund', 'other'), allowNull: false },
    status: { type: DataTypes.ENUM('pending', 'completed', 'failed', 'processing'), defaultValue: 'pending' },
